      ...
      <div className={LANDING_CONTAINER_CLASS}>
        ...
        >
          <h2 className="text-4xl sm:text-5xl font-light tracking-tight text-zinc-900">
            ...
            <br />
            <span className="text-zinc-400">{t("testimonials.titleLine2")}</span>
          </h2>
          <p className="mt-6 text-lg text-primary font-medium">{t("testimonials.subtitle")}</p>
        </motion.div>
          ...
          {TESTIMONIALS.map((testimonial) => (
            ...
            >
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-zinc-900">{t(testimonial.nameKey)}</h4>
                  <p className="text-xs text-zinc-500">{t(testimonial.roleKey)}, {t(testimonial.companyKey)}</p>
                </div>
              </div>
            </motion.div>
          ))}
