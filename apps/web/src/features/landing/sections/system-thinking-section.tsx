            ...
            {VALUES.map((value) => (
              <div key={value.titleKey} className="flex flex-col gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <h4 className="text-base font-medium text-zinc-900">{t(value.titleKey)}</h4>
                </div>
